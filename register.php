...
if (isset($_POST['signup'])) {
	...
	if (!preg_match("/^[a-zA-Z ]+$/",$username)) {
		$error = true;
		$username_error = "El nombre debe contener solo caracteres del alfabeto y espacio.";
	}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Mediante la simple utilización de HIVE y al contratar cualquiera de los servicios ofrecidos a través de devhuayra.com, el Cliente reconoce haber leído y acepta los términos expuestos en el presente Acuerdo y / o las políticas que formen parte del mismo.
        <br>
        <br>
        <p>
        	<b>Uso de la cuenta de usuario en HIVE.com</b>
        </p>
		<p>
			<ul>
